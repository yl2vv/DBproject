        ...
        $(document).ready(function() {
                $( "#ajaxAdvisor" ).change(function() {
                        $.ajax({
                                ...
                                data: {searchName: $( "#Nameinput" ).val(), searchUser: $( "#Userinput" ).val(), searchEducation: $( "#Educationinput" ).val(), searchRating: $( "#Ratinginput" ).val(), searchEmail: $( "#Emailinput" ).val(), searchAlum: $( "#Aluminput" ).val(), searchExpertise: $( "#Expertiseinput" ).val()},
...
<body>
        ...
        <input class="xlarge" id="Ratinginput" name='Ratinginput' type="search" size="30" placeholder="Minimum Rating"/>
